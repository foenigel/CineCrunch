...
const MovieDetails = () => {
    ...
    return ( 
        <div className="bg-slate-950 w-full h-auto flex items-center justify-center">
            <div className="relative w-full max-w-[1400px] h-full my-10 flex flex-col gap-4">
                ...
                <div className="relative w-full h-auto flex justify-between z-10">
                    ...
                    <div className="flex  gap-2 bg px-4 bg-slate-500/30 rounded-lg items-center justify-center">
                ...
                <div className="relative w-full h-auto flex gap-2 z-10 items-center">
                    ...
                    <span className="text-white text-xl opacity-50">&#x2022;</span>
                    <h2 className="text-white text-sm sm:text-base">2h 46m</h2>
                </div>

                <div className="relative flex flex-col justify-between gap-4 w-full z-10 mb-10 sm:flex-row overflow-x-hidden">
                    <img src={poster_path ? `https://image.tmdb.org/t/p/w500/${backdropV2}`: `${noPoster}`} alt={`${title}-Poster`} className=" text-white w-full rounded-lg shadow-lg shadow-black/40 sm:w-1/2" />
                ...
                <img src={poster_path ? `https://image.tmdb.org/t/p/original/${backdrop_path}`: `${noPoster}`} alt={`${title}-Poster`} className=" text-white rounded-lg absolute w-full h-full top-0 left-0 object-cover z-0 shadow-lg saturate-100" />
                ...
                <div className="relative flex flex-col items-center gap-4 justify-between p-4 h-auto sm:flex-row sm:items-start sm:p-10">
                    ...
                    <div className="relative grid grid-cols-[2fr_3fr] gap-2 w-full justify-between sm:grid-cols-[1fr_4fr] sm:gap-10">
                     ...
                     <Link to={"/"}><button className="bg-TrendingRed px-4 py-2 w-fit h-fit text-white flex items-center justify-center font-semibold rounded-md cursor-pointer">Visit Homepage</button></Link>
                </div>
            </div>
        </div>
     );
